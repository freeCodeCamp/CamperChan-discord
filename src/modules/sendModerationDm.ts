...
export const sendModerationDm = async(
  ...
  try {
    ...
    if (action === "ban") {
      embed.addFields({
        name:  "Appeals",
        value: `You can use [this form](https://forms.nhcarrigan.com/o/docs/forms/k7fPZmhgCS4RRKbStq8AcW/4?Discord_ID=${user.id}&?Username=${user.username}) to appeal your ban after you have [read our code of conduct](https://www.freecodecamp.org/news/code-of-conduct).`,
      });
    }
